...
while True:
      ...
      print()
      if quest == 1:
            n1 = int(input('Digite o valor da base (m): '))
            n2 = int(input('Digite o valor da altura (m): '))
            ...
            if n1 in val:
                  if soma > n5:
                        ...
                        print(f'Desta forma, a área do Triângulo é igual a: {(n1 * n2) / 2}m²')
                        print()
                  else:
                        print()
            ...
            print(f'Desta forma, a área do Quadrado é igual a: {n1**2}m²')
            print()
      elif quest == 3:
            ...
            print(f'Desta forma, a área do Retângulo é igual a: {n1*n2}m²')
            print()
      elif quest == 4:
            ...
            print(f'Desta forma, a área do Trapézio é igual a: {(n1+n2)*n3/2}m²')
            print()
      elif quest == 5:
            ...
            print()
            print(f'Desta forma, a área do Círculo é igual a: {(n1**2)*3.1415:.2f}m²\nO perímetro do Círculo é igual a: {3.1415*2*n1:.2f}m\nO diâmetro do Círculo é igual a: {n1*2}m')
            print()
      elif quest == 6:
            ...
            print()
            print(f'Desta forma, a área do Losango é igual a: {(n1*n2)/2}m²')
            print()
      elif quest == 7:
